      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Get personalized workout plans generated by our AI assistant. Just describe your fitness goals!
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex gap-4 mb-8">
            <Input
              ...
              className="bg-white/10 text-white placeholder:text-gray-400 border-gray-700"
            />
            <Button
          ...
          {workout && (
            <div className="bg-white/10 p-6 rounded-lg border border-gray-700 animate-fade-up">
              <pre className="text-white whitespace-pre-wrap font-roboto text-sm">
                {workout}
              </pre>
            </div>
          )}
